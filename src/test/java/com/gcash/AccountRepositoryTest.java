...
public class AccountRepositoryTest {
    ...
    void successfulAccountCreation() {
        ...
        Assertions.assertEquals("Mai", repository.getAccount(accountId).name());
    ...
    void successfulDelete() {
        //Setup
        AccountRepository repository = new AccountRepository();
        String id = repository.createAccount("Mai", 89.9);
    ...
    void successfulGetNumberOfAccounts() {
        ...
        String id1 = repository.createAccount("Mai", 89.9);
        String id2 = repository.createAccount("Mai", 89.9);
        String id3 = repository.createAccount("Mai", 89.9);
